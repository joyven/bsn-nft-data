package org.libra.bsn.orm.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        DataSourceConfig.Builder dcb = new DataSourceConfig.Builder("jdbc:mysql://127.0.0.1:3306/nft_data?useUnicode=true&characterEncoding=utf-8&useSSL=false","root", "")
        ...
        FastAutoGenerator generator = FastAutoGenerator
                ...
                .packageConfig(builder -> {
                    builder.parent("org.libra.bsn.orm") // 设置父包名
                            .moduleName("") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder.enableCapitalMode()
                            ...
                            .addSuperEntityColumns("createTime", "updateTime")
