...
public class HttpClientUtil {
    ...
    public static String sendGet(String url, Map<String, String> headers,
        ...
        String signature = "0V8i78/B+fIqlMTqTwznv6pZaQUM7iTidmvI3Ge+ptc=";
        httpGet.setHeader("Authorization","hmac username=\"hmac-tianzhou\", algorithm=\"hmac-sha256\", headers=\"x-date request-line\", signature="+"\""+signature+"\"");
